...
const InventoryTables = () => {
  ...
  const [saved, setSaved] = useState(false); // ✅ used for success message
  ...
  useEffect(() => {
    ...
    setSweetenings([    { id: 1, name: 'Vanilla Bean', jarQty: '', bulkQty: '' },
      { id: 2, name: 'Salted Caramel', jarQty: '', bulkQty:''},
      { id: 3, name: 'Brown Sugar-Cinnamon', jarQty: '', bulkQty: '' },
      { id: 4, name: 'Chocolate', jarQty: '', bulkQty: '' },
      { id: 5, name: 'Strawberry', jarQty: '', bulkQty: '' },
      { id: 6, name: 'Coconut', jarQty: '', bulkQty: '' },
      { id: 7, name: 'Lemon', jarQty: '', bulkQty: '' },
      { id: 8, name: 'Pumpkin Spice', jarQty: '', bulkQty: '' },
      { id: 9, name: 'Peppermint', jarQty: '', bulkQty: '' },
      { id: 10, name: 'UBM', jarQty: '', bulkQty: '' },
      { id: 11, name: 'Gluten Free UBM', jarQty: '', bulkQty: '' },]);
    setMiscItems([{ id: 1, name: 'CookBooks', Qty: '',  },
      { id: 2, name: 'Spice Spinners', Qty: '',  },]);
    setSamplers([{ id: 1, name: "Seasoning Sampler", Qty: '' },
